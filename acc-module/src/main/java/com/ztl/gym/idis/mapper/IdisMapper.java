...
public interface IdisMapper {
     ...
     * @return 结果集
     */
    List<Map<String, String>> selectCodeNotSynced(@Param(value = "maxNum") Integer maxNum,@Param(value = "companyId") Long companyId);

    /**
     * 给成功同步的码更新状态
     * @param codeList 需要更新状态的码
     */
    void updateStatusForSyncedCode(List<String> codeList,Long companyId);
