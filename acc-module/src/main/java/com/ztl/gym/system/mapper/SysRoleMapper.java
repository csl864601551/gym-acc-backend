...
public interface SysRoleMapper {
     ...
     * @return 角色信息
     */
    public SysRole checkRoleNameUnique(@Param(value="roleName")String roleName,@Param(value="createBy")String createBy);
     ...
     * @return
     */
    List<SysRole> selectRoleByCreator(String creator);
}
