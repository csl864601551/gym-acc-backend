...
import com.ztl.gym.framework.security.filter.JwtAuthenticationTokenFilter;
import com.ztl.gym.framework.security.handle.AuthenticationEntryPointImpl;
import com.ztl.gym.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        httpSecurity
                ...
                .antMatchers("/mix/record/download").anonymous()
                .antMatchers("/area/area/download").anonymous()
                .antMatchers("/system/dept/download").anonymous()
                .antMatchers("/system/dept/downloadStock").anonymous()
